...
#             LangChain · LangGraph · Vertex AI · DeepSeek ·
#             local llama.cpp / vLLM / Ollama runtimes ·
#             and any system_prompt-capable surface
# ============================================================
# Audit lineage:
...
- Quality checklist
- Universal compatibility (Claude, Mistral, Gemini, Gemma, Qwen, OpenAI, LFM, Cerberus, CrewAI, AutoGen, LangChain, LangGraph, Vertex AI, DeepSeek, local runtimes)
